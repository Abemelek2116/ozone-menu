...
OzoneFilters.prototype.price = function () {
    ...
    this.menu.filters.price = this.menu.filters.price || {};
...
OzoneFilters.prototype.calories = function () {
    ...
    this.menu.filters.calories = this.menu.filters.calories || {};
...
OzoneFilters.prototype.toggles = function () {
    ...
    this.menu.filters.featuredOnly =
        ...
        this.elements.featured?.checked || false;

    this.menu.filters.chefOnly =

        this.elements.chef?.checked || false;

    this.menu.filters.seasonalOnly =

        this.elements.seasonal?.checked || false;

    this.menu.filters.dailySpecialOnly =

        this.elements.specials?.checked || false;

    this.menu.filters.availability =

        this.elements.availability?.checked !== false;
